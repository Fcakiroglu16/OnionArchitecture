...
public class WriteRepositoryManager : IWriteRepositoryManager
{
    ...
    public WriteRepositoryManager(IReadDatabaseSettings readDatabaseSettings)
    {
        _productWriteRepository =
            new Lazy<IWriteProductRepository>(() => new WriteProductRepository(readDatabaseSettings));
        _categoryWriteRepository =
            new Lazy<IWriteCategoryRepository>(() => new WriteCategoryRepository(readDatabaseSettings));
    }
